    ...
    return (
        <div className={'h-0 w-0 relative'} style={{rotate: `${index * 45}deg`}}>
            <div className={'h-0 w-0 relative'} style={{rotate: `${ 112.5}deg`}}>
                <div className={'bg-portfolio-indigo rounded-full absolute origin-left left-0 top-0 -translate-y-1/2 hover:bg-portfolio-cyan cursor-pointer transition-colors duration-200'}
                     style={{
                         width: `${gap}px`,
